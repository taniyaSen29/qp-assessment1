...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2024 at 05:09 PM
...
INSERT INTO `grocery_items` (`id`, `name`, `price`, `inventory`) VALUES
(1, 'Mango', 200.00, 16),
(2, 'Apple', 100.00, 26);
...
(1, 2, 1, 1, '2024-01-25 18:20:44'),
(2, 2, 2, 1, '2024-01-25 18:20:44');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `grocery_items` (`id`);
COMMIT;
